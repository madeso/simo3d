...
ConsoleDlgBase::ConsoleDlgBase( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxDialog( parent, id, title, pos, size, style )
{
	...
	// Connect Events
	dInput->Connect( wxEVT_COMMAND_TEXT_ENTER, wxCommandEventHandler( ConsoleDlgBase::OnInputEnter ), NULL, this );
}

ConsoleDlgBase::~ConsoleDlgBase()
{
	// Disconnect Events
	dInput->Disconnect( wxEVT_COMMAND_TEXT_ENTER, wxCommandEventHandler( ConsoleDlgBase::OnInputEnter ), NULL, this );
}
